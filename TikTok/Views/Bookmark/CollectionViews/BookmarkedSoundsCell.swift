...
import UIKit
class BookmarkedSoundsCell: UICollectionViewCell {
    ...
    //MARK: - Properties
    let cellId = "BookmarkedSoundsCellCellId"
    ...
    fileprivate func setUpViews() {
        ...
        collectionView.register(FavoriteSoundsCell.self, forCellWithReuseIdentifier: cellId)
    }
...
extension BookmarkedSoundsCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
