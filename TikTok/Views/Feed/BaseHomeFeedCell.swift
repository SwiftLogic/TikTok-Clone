...
import UIKit
protocol BaseHomeFeedCellDelegate: class {
...
class BaseHomeFeedCell: UICollectionViewCell {
    ...
    //MARK: - Properties
    lazy var posts = handleCreatePosts()
...
extension BaseHomeFeedCell: VerticalFeedCellDelegate {
    ...
    fileprivate func handleCreatePosts() -> [Post] {
        ...
        let creationDate: Date = Date()
         ...
         let ownerUid: String = handleSetUpUsers().uid
        ...
        let firstPost = Post(user: handleSetUpUsers(), dictionary: postDict)
        ...
        let secondownerUid: String = handleSetUpUsers().uid
        ...
        let secondPost = Post(user: handleSetUpUsers(), dictionary: secondpostDict)
